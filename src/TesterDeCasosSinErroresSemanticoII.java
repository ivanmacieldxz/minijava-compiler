...
public class TesterDeCasosSinErroresSemanticoII {

    private static final String msgExito = "[SinErrores]";
    private static final String testFilesDirectoryPath = "resources/sinErrores4/";

    //TODO: el tipo de esta variable init tiene que ser la clase que tiene el main
    private static final SemanticIIMainKt init = null;
    ...
    public TesterDeCasosSinErroresSemanticoII(String input){
        this.input = input;
    }
